...
- [ ] Subscription **title** displayed (matches ASC reference name)
- [ ] Subscription **length** displayed ("monthly" / "yearly" / "week" / etc.)
- [ ] **Price** per period displayed (e.g. "$4.99/month")
- [ ] Price-per-unit displayed if not obvious on the primary unit
...
- [ ] Tappable **Privacy Policy** link — opens live URL (not `mailto:`)
- [ ] Tappable **Terms of Use (EULA)** link — opens live URL
- [ ] **Restore Purchases** button visible
- [ ] Cancel / Dismiss button visible (not a dark pattern — reviewer must
...
TBD after Stage 1 code (PaywallView.swift)
<!--
