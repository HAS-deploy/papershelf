# App Privacy (nutrition label) answers — PaperShelf
...
For PaperShelf: No, we do not collect data (nutrition label: Data Not Collected), aside from Apple-handled purchase receipts.
